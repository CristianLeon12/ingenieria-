 ...
 *  href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">StdIn.java</a>
 ...
 *  href = "http://docs.oracle.com/javase/7/docs/api/java/util/Scanner.html#number-syntax">Scanner,
 ...
 *  href = "http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4508058"byte-order mask.
 *  If the input begins with the optional byte-order mask, StdIn
 *  will have an extra character \uFEFF at the beginning.
 *  
 *  Reference. 
 *  For additional documentation,
 *  see href="https://introcs.cs.princeton.edu/15inout">Section 1.5of   
